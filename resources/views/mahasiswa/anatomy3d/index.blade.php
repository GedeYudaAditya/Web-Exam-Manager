...
@section('content')
    <div class="container mt-20">
        <h3 class="text-center font-bold text-2xl mb-5">Anatomy 3D</h3>
        <div class="grid grid-cols-3 gap-4 mb-5">
            <a href="{{ route('mahasiswa.media.anatomy3d.detail', 'paru') }}">
                <div
            ...
            <a href="{{ route('mahasiswa.media.anatomy3d.detail', 'ginjal') }}">
                <div
                    class="bg-slate-300 p-10 rounded group shadow-md hover:bg-blue-500 hover:text-white transition-all ease-in-out">
                    <div class="grid grid-cols-2 gap-4 justify-center items-center">
            ...
            <a href="{{ route('mahasiswa.media.anatomy3d.detail', 'reproduksi') }}">
                <div
                    class="bg-slate-300 p-10 rounded group shadow-md hover:bg-blue-500 hover:text-white transition-all ease-in-out">
                    <div class="grid grid-cols-2 gap-4 justify-center items-center">
                        <img src="{{ asset('images/3d-model-icon.webp') }}" alt="anatomy 3d"
