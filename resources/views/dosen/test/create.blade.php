...
@section('content')
    <div class="container pt-20">
        <h3 class="text-center font-bold text-2xl mb-5">Buat Test {{ $jenis }}</h3>
        <div class="container dark:bg-slate-800 rounded shadow-md p-10 mb-20 bg-white">
            ...
            <form action="{{ $route_store }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="name" id="nama" placeholder="Nama Test" required
                ...
                <div class="mb-5">
                    ...
                    <textarea name="description" id="description" cols="30" rows="10"
                        class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300"></textarea>
                </div>
                <div class="mb-5">
                    <label for="passing_score" class="block mb-2 font-bold text-xl text-white">Passing Score <span
                            class="text-red-500">*</span></label>
                    <input type="number" name="passing_score" id="passing_score" placeholder="Passing Score" required
                        class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300">
                </div>
                <div class="mb-5">
                    <label for="duration" class="block mb-2 font-bold text-xl text-white">Durasi <span
                            class="text-red-500">*</span></label>
                    <input type="number" name="duration" id="duration" placeholder="Durasi (menit)" required
                        class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300">
                </div>
