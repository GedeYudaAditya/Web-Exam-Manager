...
class ReportExport implements FromCollection, WithHeadings, WithStyles
{
    ...
    //     $drawing->setName('Universitas Pendidikan Ganesha');
    ...
    {
        // ambil semua data dari model dengan hasil test untuk user yang sama mengambil data nilai test yang terbaik
